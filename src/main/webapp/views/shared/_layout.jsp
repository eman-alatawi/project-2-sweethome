       ...
       <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <span class="float-right">
          ...
          <% if(session.getAttribute("userRole").equals("owner")){ %>
           <li class="nav-item"><a href="${appName}user/ownerProfile?id=${user.id}" ><%-- <img class="card-img-top" src="${appName}${user.photosImagePath}" alt="profile photo" /> --%><img class="object-cover  w-10 h-10 rounded-full mr-10 ring-4 ring-indigo-400 ring-opacity-50" src="${user.userImage}" alt="profile photo"/> </a></li>
           <%} else { %>
            <li class="nav-item"><a href="${appName}user/renteeProfile?id=${user.id}" ><img class="object-cover  w-10 h-10 rounded-full mr-10 ring-4 ring-indigo-400 ring-opacity-50" src="${user.userImage}" alt="profile photo"/></a></li>
            <%} %>
